...
export default function AttestationNonBenifisPret() {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/nonBenifisPret/`
        );
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/nonBenifisPret/${row._id}`,
                                  {
                                    method: "PATCH",
                                    headers: {
                              ...
                              try {
                                let response = await fetch("http://localhost:5000/api/notification/addNotification", {
                                  ...
                                  body: JSON.stringify({
                                    ...
                                    message: "Votre demande d'attestation de benifis prèt est bien pris en charge",

...
import ModalGalerie from "../../components/Modal/modalGalerieCapitalDeces";
...
export default function CapitalDeces() {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/capitalDeces`
        );
        ...
        setList(responseData.capitalDeces);
      } catch (err) {
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/capitalDeces/${row._id}`,
                                  {
                                    method: "PATCH",
                                    headers: {

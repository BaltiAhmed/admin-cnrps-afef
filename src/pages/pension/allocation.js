...
import ModalGalerie from "../../components/Modal/modalGalerieAllocation";
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/allocation`
        );
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/allocation/${row._id}`,
                                  {
                                    method: "PATCH",
                                    headers: {
                              ...
                              try {
                                let response = await fetch("http://localhost:5000/api/notification/addNotification", {
                                  ...
                                  body: JSON.stringify({
                                    sujet: "Demande d'allocation",
                                    message: "Votre demande d'allocation est bien pris en charge",

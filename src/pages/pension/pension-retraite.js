...
import ModalGalerie from "../../components/Modal/modalGaleriePensionReraite";
...
export default function PensionRetraite() {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/pensionretraite/`
        );
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/pensionretraite/${row._id}`,
                                  {
                                    method: "PATCH",
                                    headers: {
                              ...
                              try {
                                let response = await fetch("http://localhost:5000/api/notification/addNotification", {
                                  ...
                                  body: JSON.stringify({
                                    sujet: "Demande pension retraite",
                                    message: "Votre demande de pension retraite est bien pris en charge",

...
import ModalGalerie from "../../components/Modal/modalGaleriePretPersonel";
...
export default function PretPersonel() {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/pretPersonnel`
        );
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/pretPersonnel/${row._id}`,
                                  {
                                    method: "PATCH",
                                    headers: {

...
import ModalGalerie from "../../components/Modal/modalGaleriePretUniversitaire";
...
export default function PretUniversitaire() {
    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          `http://localhost:5000/api/pretUniversitaire`
        );
                            ...
                            onClick={async (event) => {
                              try {
                                let response = await fetch(
                                  `http://localhost:5000/api/pretUniversitaire/${row._id}`,
                                  {
                                    method: "PATCH",
                                    headers: {
                              ...
                              try {
                                let response = await fetch("http://localhost:5000/api/notification/addNotification", {
                                  ...
                                  body: JSON.stringify({
                                    sujet: "Demande de capital décés",
                                    message: "Votre demande de capital décés est bien pris en charge",
